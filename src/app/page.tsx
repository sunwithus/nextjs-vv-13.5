  ...
  return (
    <main className="flex flex-col items-center justify-between p-6 pt-16 pb-16 min-h-full">
      ...
      <div className="mb-4 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left">
        ...
        <a href="https://webhost1.ru/?r=36741" className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30" rel="noopener noreferrer" target="_blank">
          <h2 className={`mb-3 text-2xl font-semibold`}>
            webhost1.ru <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">-&gt;</span>
          </h2>
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Хостинг сайтов, при переходе по ссылке получите скидку по промокоду: 7bb60c-10</p>
        </a>

        <a href="https://office.agenyz.com/?bonus=007-7310399&language=ru" className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30" rel="noopener noreferrer" target="_blank">
          <h2 className={`mb-3 text-2xl font-semibold`}>
            Agenyz <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">-&gt;</span>
          </h2>
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>БАДы, которые работают, регистрируйтесь по ссылке в премиальной программе</p>
        </a>
      </div>
    </main>
  );
